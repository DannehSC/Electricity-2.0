...
addCommand('Cat picture','Gets a cat picture',0,false,false,false,function(message,args)
...
addCommand('Urban','Urban dictionary','urban',0,false,false,false,function(message,args)
	local data=urban(args[1])
